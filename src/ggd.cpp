...
/// @brief Constructor for gradient decent object with no prespecified lambda value.
/// @param[in] x
...
/// @brief Constructor for gradient decent object with prespecified lambda value.
/// @param[in] x
/// Data for predictor variables. (nxp)
/// @param[in] y
/// Column vector of response data. (p)
